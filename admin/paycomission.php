...
?>
	...
	<div class="container" align="center">
							<center>
								<caption> <h2>Comission Paid</h2></caption>
							</center>
						...
						while($data=mysqli_fetch_array($doQ))
							{
								...
								if($name== $Employee)
									...
									$nm='doLink';
								?>
								<a href="paycomission.php?name=<?php echo $name;?>" id="<?php echo $nm;?>" class="button">
								<?php
								echo $data['EmpName']."</a>";
							}
					?>
																...
																<tr>
																	...
																	<td style="text-align: left;" >
																			<select name="typeselect" id="sBox">
																				<option>MFS Comission</option>
																				<option selected>Market SIM Comission</option>
																				<option>Activity SIM Comission</option>
																				<option>Device+Handset Comission</option>
																				<option>PostPaid Comission</option>
									...
									<tr>
										...
										<th>Action</th>
											...
											<tbody>
													...
													$dateNow1=date('Y-m-d');
													$sum=0;
													$sql = mysqli_query($con,"SELECT * FROM comission WHERE rp='Paid' AND comEmp='$Employee' AND comDate BETWEEN '$QueryFD' AND '$QueryLD'")or die(mysqli_query());
