...
?>
	<div class="container" align="center">
							...
							<center>
								<caption> <h2>Payment Summary</h2></caption>
							</center>
							...
							<div  style="border: dashed blue 0px; ">
											<form id="AddReceiptForm" name="AddReceiptForm" action="" method="POST">
													...
													<table cellpadding="0" cellspacing="0" border="0" class="table" id="headTable" >
																<tr>
																	<td style="text-align: right;"> Paid To:  </td>
																	...
																	<td style="text-align: left;" >Paid For:
																			<select name="ocSelect" id="sBox">
																				<option selected>---</option>
																				<?php
																					$doQ=mysqli_query($con,"SELECT DISTINCT rpFor FROM receiptpayment WHERE rpStatus='PaidTo' ");
																						while($data=mysqli_fetch_array($doQ))
																						{
																	...
																	<td style="text-align: left;">
										 								...
										 								<input type="submit"  value="Show" name="Showpayments" id="Btn">
																		</td>
																</tr>
											...
											<tbody>
													...
													$d=strtotime($Dat);
																	...
																	if ($currentUserType=="Admin" && $Dat>=$QueryFD && $Dat<=$QueryLD)
																		echo "<td><a href=\"delete/delpaymentsummary.php?ID=".$id."\" id=\"LinkBtnDel\">Delete</a></td>";
