...
include_once('includes/globalvar.php');
	...
	if (isset($_POST['AddIntoIncomeExp']))
	{
		...
		else
		{
				...
				$valuesToAdd= " '$dt','expense','$Desc',$Amnt";
					//echo "$columnsToAdd". "<br>"."$valuesToAdd";
				$sq = mysqli_query($con,"INSERT INTO fixedexp($columnsToAdd) values($valuesToAdd)")or die(mysqli_query());
		}
	}
?>
<head>
	...
	<div class="container" align="center">
						<center> <caption> <h2>Fixed Expenses</h2></caption> </center>
...
<br>
		...
		<table cellpadding="0" cellspacing="0" border="1" class="" id="dbResult">
												...
												<?php
															$sum=0;								
													$sql = mysqli_query($con,"SELECT * FROM fixedexp WHERE  type='expense'")or die(mysqli_query());
														WHILE($Data=mysqli_fetch_array($sql))
															...
															<tr>
																...
																<td><a href="delete/delexpfix.php?ID=<?php echo $id;?>" id="LinkBtnDel">Delete</a></td>
