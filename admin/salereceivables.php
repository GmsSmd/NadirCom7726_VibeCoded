...
?>
			<head>
				...
				<center>
					<caption> <h1>SALES RECEIVABLES</h1></caption>
				</center>
		...
		$doQ=mysqli_query($con,"SELECT EmpName from empinfo WHERE EmpStatus='Active' Order by sort_order ASC");
			while($data00=mysqli_fetch_array($doQ))
				...
				<tr >
					<td rowspan="5"><?php echo $Employee; ?> </td>
					<td >LMC</td>
					<td ><?php echo $openCash; ?></td>
					<td ><?php echo $load+$mfsClose; ?></td>
					<td ><?php echo $takenLFS; ?></td>
					<td ><?php echo $CashClose1; ?></td>
					<td rowspan="5" style="text-align: center; font-weight: bold;" ><?php echo $CashClose1+$cardClose1+$MobileClose1+$SIMClose1; ?> </td>
				</tr>
				<tr >
					<td >Card</td>
				...
				<tr style="text-align:center; color: black; font-weight: bold; background:#9999ff;">
					<td>TOTAL:</td>
					<td style="text-align: center; " ><?php echo $openCash+$openCardCash+$openMobileCash+$openSIMCash; ?></td>
					<td style="text-align: center; " ><?php echo $load+$mfsClose+$sAmountCard+$sAmntSum0+$sAmntSum1; ?></td>
					<td style="text-align: center; " ><?php echo $takenLFS+$takenCard+$takenMbl+$takenSIM; ?></td>
					<td style="text-align: center; " ><?php echo $CashClose1+$cardClose1+$MobileClose1+$SIMClose1; ?></td>
				</tr>
