							...
							<form name="f1" action="" method="POST">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="HeadTable" >
												<tr>
													...
													<td style="text-align: left;" >
														<input type="text" name="txtLoad" id="tBox1" autofocus>
														@<input type="text" name="txtLoadMrgn" id="tBox2" value="<?php echo $marginSent*100; ?>">%
												...
												<tr>
													...
													<input type="submit"  value="Go" name="Go1" id="Btn" accesskey="g">
													</td>
												</tr>
									</table>
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="HeadTable" >
										<tr>
											<td>
													<table cellpadding="0" cellspacing="0" border="0" class="table" id="HeadTable" >
														<tr>
															<td colspan="4"style="text-align: center;"> <h2>Card Section</h2></td>
														</tr>
														<tr>
															<td style="text-align: right;">Type: </td>
															<td style="text-align: left;" >
																<select name="SubCselect" id="sBox1">
																		<!-- <option >---</option> -->
																		<?php
															...
															<td style="text-align: left;" >
																<input type="text" name="txtCQty" id="tBox1"> 
															</td>
														</tr>
														<tr>
															<td style="text-align: right;" >Sale Rate:</td>
															<td style="text-align: left;" >
																<input type="text" name="txtCSaleRate" id="tBox1"> 
															</td>
															<td style="text-align: right;" >Comments:</td>
															<td style="text-align: left;" >
																<input type="text" name="txtCardCmnt" id="tBox1"> 
															</td>
														...
														<tr>
															<td colspan="4" style="text-align: center;" >Receive Amount:
																	<select name="modeSelect1" id="sBox1">
																		<option >---</option>
																		<?php
																		$doQ=mysqli_query($con,"SELECT modeName from rpmode");
																		while($data=mysqli_fetch_array($doQ))
																...
																<input type="text" name="txtCardAmntRec" id="tBox1">
											...
											<td>
													<table cellpadding="0" cellspacing="0" border="0" class="table" id="HeadTable" >
														<tr>
															<td colspan="4"style="text-align: center;"> <h2>Phone Section</h2></td>
														</tr>
														<tr>
															<td style="text-align: right;">Type: </td>
															<td style="text-align: left;">
															...
															<td style="text-align: left;" >
																<input type="text" name="txtPQty" id="tBox1"> 
															</td>
														</tr>
														<tr>
															<td style="text-align: right;" >Sale Rate: 
															</td>
													
															<td style="text-align: left;" >
																 <input type="text" name="txtPSaleRate" id="tBox1"> 
															</td>
															<td style="text-align: right;" >Comments: 
															</td>
															<td style="text-align: left;" >
																 <input type="text" name="txtPCmnt" id="tBox1"> 
															</td>
														</tr>
														<tr>
															<td></td>
														...
														<tr>
															<td colspan="4" style="text-align: center;" >Receive Amount:
																	<select name="modeSelect2" id="sBox1">
																		<option >---</option>
																		<?php
																		$doQ=mysqli_query($con,"SELECT modeName from rpmode");
																		while($data=mysqli_fetch_array($doQ))
																...
																<input type="text" name="txtMobAmntRec" id="tBox1">
											...
											<td>
													<table cellpadding="0" cellspacing="0" border="0" class="table" id="HeadTable" >
														<tr>
															<td colspan="4"style="text-align: center;"> <h2>SIM Section</h2></td>
														</tr>
														<tr>
															<td style="text-align: right;">Type: </td>
															<td style="text-align: left;" >
																<select name="SubSselect" id="sBox1">
																	<option >---</option>
																		<?php
															...
															<td style="text-align: left;" >
																 <input type="text" name="txtSQty" id="tBox1"> 
															</td>
														</tr>
														<tr>
															<td style="text-align: right;" >Sale Rate: 
															...
															<td style="text-align: left;" >
																 <input type="text" name="txtSSaleRate" id="tBox1"> 
															</td>
															<td style="text-align: right;" >Comments: 
															</td>
															<td style="text-align: left;" >
																 <input type="text" name="txtSCmnt" id="tBox1"> 
															</td>
														</tr>
														<tr>
															<td></td>
														...
														<tr>
															<td colspan="4" style="text-align: center;" >Receive Amount:
																	<select name="modeSelect3" id="sBox1">
																		<option >---</option>
																		<?php
																		$doQ=mysqli_query($con,"SELECT modeName from rpmode");
																		while($data=mysqli_fetch_array($doQ))
																...
																<input type="text" name="txtSIMAmntRec" id="tBox1">
					...
					// Footer Sums
							...
							$sumTaken=$sumTaken+$taken;
								...
								<tr>
									...
									<td><b><?php echo $load; ?></b></td>
									<td><?php echo $transfer; ?></td>
									<td><?php echo round($Profit+$XsProfit,2); ?></td>
									<td><b><?php echo $mfsSend; ?></b></td>
									<td><b><?php echo $mfsReceive; ?></b></td>
									...
									<td><b><?php echo $taken; ?></b></td>
									<?php if ($dues==0)
									        echo "<td style=\"color: black;\"><b>".$dues."</b></td>";
									       else
									       echo "<td style=\"color: Red;\"><b>".$dues."</b></td>";;
									?>
