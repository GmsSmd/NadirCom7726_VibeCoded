...
?>
			<head>
				<title>Mobile Receivables</title>
					<style>
						<?php
		...
		<table cellpadding="0" cellspacing="0" border="1" align="center" id="dbResult">
				<tr>
					<td colspan="5"> 
						<center><h2> Receivables Against Mobile </h2></center>
					</td>
				</tr>
				<tr>
        					<td colspan="5" style="text-align: center;"> Date UpTo:
        						...
        						?>
        						<input type="submit"  value="Show" name="getmobDue" id="Btn">
        					</td>
        				</tr>
				<tr>
