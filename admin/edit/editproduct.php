...
$desc1=$product['pDescription'];
	...
	if (isset($_POST['Edit']))
	{
		...
		$rname=$_POST['txtName'];
		$rDesc=$_POST['txtDesc'];
		echo $rid . $rname . $rDesc ;

		$rsq = mysqli_query($con,"UPDATE products SET pName='$rname', pDescription='$rDesc' WHERE pID = $rid ")or die(mysqli_query());
		
		echo '<script type="text/javascript">alert("'. $rname .' Successfully Updated");</script>';
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="HeadTable" >
											...
											<tr>
												...
												<tr>
													...
													value="<?php echo $desc1; ?>">
													</td>
												</tr>
												<tr>
													<td colspan="2" style="text-align: center;" > 
														<input type="submit"  value="Update" name="Edit" id="Btn"> <a href="../addproduct.php"><< back</a>
													</td>
												</tr>
									</table>
							</form>
