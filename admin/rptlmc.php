...
?>
		...
		<table cellpadding="0" cellspacing="0" border="1" align="center" id="dbResult">
				<tr >
					<td colspan="5" > 
						<center><h2> Receivables Against LMC</h2></center>
					</td>
				</tr>
				<tr>
        					<td colspan="5" style="text-align: center;"> Date UpTo:
        						...
        						?>
        						<input type="submit"  value="Show" name="getlmcDue" id="Btn">
        					</td>
        		</tr>
				<tr >
			...
			if ($CashClose!=0)
			{
				...
				<tfoot >
					<tr style="border: solid black 2px;"  >
						...
						<td> <b><?php //echo $sumLoad+$sumClose; ?></b></td>
